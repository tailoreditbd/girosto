(function(){
  ...
  if(buy)buy.addEventListener("click",function(){if(GirostoStore.add(button.dataset.productId,Number(select.value),Number(document.getElementById("productQty")?.value||1)))location.href="../../cart"});
