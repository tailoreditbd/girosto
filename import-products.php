...
$categories = [
    'চালঃ' => ['slug' => 'rice', 'name' => 'Rice', 'file' => 'rice.html', 'icon' => 'bi-basket2'],
    'সরিষার তেলঃ' => ['slug' => 'mustard-oil', 'name' => 'Mustard Oil', 'file' => 'mustard-oil.html', 'icon' => 'bi-droplet-half'],
    'অয়েলঃ অলিভ/ সানফ্লাওয়ার/কোকোনাট' => ['slug' => 'healthy-oils', 'name' => 'Healthy Oils', 'file' => 'healthy-oils.html', 'icon' => 'bi-moisture'],
    'ডালঃ' => ['slug' => 'lentils-pulses', 'name' => 'Lentils & Pulses', 'file' => 'lentils-pulses.html', 'icon' => 'bi-circle-half'],
    'মশলাপাতিঃ' => ['slug' => 'ground-spices', 'name' => 'Ground Spices', 'file' => 'ground-spices.html', 'icon' => 'bi-fire'],
    'আস্ত মসলাঃ' => ['slug' => 'whole-spices', 'name' => 'Whole Spices', 'file' => 'whole-spices.html', 'icon' => 'bi-stars'],
    'চিনিঃ' => ['slug' => 'sugar', 'name' => 'Sugar', 'file' => 'sugar.html', 'icon' => 'bi-hexagon'],
    'গুড়ঃ' => ['slug' => 'jaggery', 'name' => 'Jaggery', 'file' => 'jaggery.html', 'icon' => 'bi-brightness-alt-high'],
    'হোম মেইড আচারঃ' => ['slug' => 'homemade-pickles', 'name' => 'Homemade Pickles', 'file' => 'homemade-pickles.html', 'icon' => 'bi-jar'],
    'Seeds:' => ['slug' => 'healthy-seeds', 'name' => 'Healthy Seeds', 'file' => 'healthy-seeds.html', 'icon' => 'bi-flower1'],
    'Essential Oil/ Hair Care/ Skin Care' => ['slug' => 'hair-skin-care', 'name' => 'Hair & Skin Care', 'file' => 'hair-skin-care.html', 'icon' => 'bi-heart'],
    'ডেইরি/পোল্ট্রিঃ' => ['slug' => 'dairy-poultry', 'name' => 'Dairy & Poultry', 'file' => 'dairy-poultry.html', 'icon' => 'bi-egg'],
    'অন্যান্য ডেইলি নিডসঃ' => ['slug' => 'daily-needs', 'name' => 'Daily Needs', 'file' => 'daily-needs.html', 'icon' => 'bi-bag-check'],
    'গিরস্ত স্পেশালঃ' => ['slug' => 'girosto-special', 'name' => 'Girosto Special', 'file' => 'girosto-special.html', 'icon' => 'bi-award'],
    'মধুঃ' => ['slug' => 'honey', 'name' => 'Original Honey', 'file' => 'honey.html', 'icon' => 'bi-droplet'],
    'খেজুর/ ড্রাই ফ্রুটস' => ['slug' => 'dates-dry-fruits', 'name' => 'Dates & Dry Fruits', 'file' => 'dates-dry-fruits.html', 'icon' => 'bi-sun'],
    'বাদামঃ' => ['slug' => 'nuts', 'name' => 'Premium Nuts', 'file' => 'nuts.html', 'icon' => 'bi-nut'],
    'হার্ব পাউডার' => ['slug' => 'herb-powders', 'name' => 'Herb Powders', 'file' => 'herb-powders.html', 'icon' => 'bi-flower3'],
    'হেলথ আইটেমঃ' => ['slug' => 'health-items', 'name' => 'Health Items', 'file' => 'health-items.html', 'icon' => 'bi-activity'],
    'ফল-ফলাদিঃ' => ['slug' => 'fresh-fruits', 'name' => 'Fresh Fruits', 'file' => 'fresh-fruits.html', 'icon' => 'bi-apple'],
];
